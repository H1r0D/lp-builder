...
const NAV_ITEMS = [
    { icon: IconFolder, label: 'プロジェクト', href: '/dashboard' },
    { icon: IconChart, label: '解析', href: '/dashboard/analytics' },
    { icon: IconSettings, label: '設定', href: '#' },
];
...
export function DashboardShell({ children, headerTitle, headerActions }: DashboardShellProps) {
        ...
        <div className="h-screen flex bg-[#f8fafc]">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <header className="h-12 bg-white border-b border-border flex items-center px-6 gap-4 shrink-0">
                    <h1 className="text-sm font-semibold text-foreground flex-1">{headerTitle}</h1>
